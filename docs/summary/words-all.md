...
- /ʌ/: cup, luck, love, come, some, money, enough, country
- /ɑː/: car, father, start, heart, large, half, dance, example
- /ɔː/: call, law, autumn, water, thought, caught, taught, bought
...
- sm-: small, smart, smile, smooth, smoke, smell
- sn-: snow, snake, snack, snap, snore, sneeze
- br-: bring, break, brother, brown, brain, branch
- cr-: create, cry, cross, crowd, crazy, critical
- dr-: drive, drink, dream, draw, drop, dress
- tr-: try, tree, true, trust, travel, trouble
- bl-: black, blue, blood, blow, block, blame
- cl-: class, clean, clear, close, clock, climb
- gl-: glad, glass, global, glove, glimpse
- fr-: from, friend, free, fresh, fruit, freeze
- gr-: great, green, group, grow, ground, grade
- pr-: practice, problem, produce, project, probably
...
- -s规则示例：
  ...
  - /ɪz/: boxes, watches, misses, catches, changes
- -ed规则示例：
  - /t/: worked, stopped, helped, watched, laughed
...
- 焦点词练习：really, absolutely, definitely, completely
- 语调练习词：yes, no, maybe, perhaps, however, therefore
- 缩略形式：I'm, you're, he's, she's, it's, we're, they're, can't, won't, wouldn't

---

**使用提示**：
1. 每个音标组合5-10个高频词进行集中练习
2. 标注音标帮助准确发音
3. 使用最小对立对进行对比训练
4. 按照从易到难的顺序排列单词
5. 可根据学员水平调整词汇难度